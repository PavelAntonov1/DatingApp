  ...
  const changeFileHandler = async (e) => {
    ...
    if (file?.type.startsWith("image")) {
      ...
      if (compressedImage.size < 100950) {
        ...
        setError(
          "The selected image is too heavy.Select the image no more than 1mb"
        );
      }
    }
    ...
    if (file?.type.startsWith("video")) {
      if (file.size < 10485760) {
        ...
        setError(
          "The selected video is too heavy.Select the video no more than 10MB"
        );
      }
    }
  };
        ...
        {(messages.length === 0 || !messages) &&
          ...
          !isLeaving && (
            <p className="text-center text-muted">
              There are no messages with this user ...
            </p>
          )}
  ...
  if (withUser === "select") {
    content = (
      ...
      >
        ...
        <span className="text-muted">Choose dialogue ...</span>
      </Card>
    );
  }
